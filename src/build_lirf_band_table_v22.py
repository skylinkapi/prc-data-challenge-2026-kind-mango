"""Step 6: refined Step A band table (v22).

Splits the (14400, 25000] band into three tighter bands per MODEL_ANALYSIS.md
appendix (2026-09-09 second audit).
"""
import glob, os, json
import numpy as np
import pandas as pd
...
def main():
    ...
    out = os.path.join(MODELS, "lirf_band_table_v22.json")
