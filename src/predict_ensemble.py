"""Apply the v5+v6 ensemble to ranking.parquet, produce kind-mango_v3.parquet.

Blend weights: 0.54 * v5 + 0.46 * v6 (from grid search on hold-out).
"""
import os
import pickle
import sys
