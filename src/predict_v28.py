"""v28 = v26 pipeline unchanged but 7-seed R_all_v27 mean (isolate ensemble effect)."""
...
def main(out_name="kind-mango_v28.parquet"):
    t0 = time.time()
    ...
    # v26-style LIRF regime head (NO Step 2 fixes)
    print("LIRF regime head v23 (no Step 2 fixes)...")
    ...
    # ORIGINAL ITY340 (as in v26, unfixed)
...
if __name__ == "__main__":
    name = sys.argv[1] if len(sys.argv) > 1 else "kind-mango_v28.parquet"
    main(name)
