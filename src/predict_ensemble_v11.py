"""Apply 6-model ensemble to ranking.parquet.
Weights: v11=0.40, v10=0.25, v7=0.20, v9=0.15, v5=0, v6=0.
"""
import os
import pickle
import sys
...
WEIGHTS = {"v7": 0.20, "v9": 0.15, "v10": 0.25, "v11": 0.40}
...
def main(out_name: str = "kind-mango_v4.parquet"):
    t0 = time.time()
    ...
    print(f"\n[ok] rows={len(out):,}, id set matches")
...
if __name__ == "__main__":
    name = sys.argv[1] if len(sys.argv) > 1 else "kind-mango_v4.parquet"
    main(name)
