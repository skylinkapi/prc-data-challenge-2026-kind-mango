...
| kind-mango_v49 | pending | — | Fifteenth-pass Phase 1: MD2+MH1 rebuild of the LIRF head without the 56 drifted columns (38 `ec_*` + 9 `opdi_*` + 9 `opdi_live_*`, D1). `src_v3/train_lirf_head_v49.py` retrains R_norm 5 seeds and p_fb+isotonic; paired LIRF hold-out FULL 887 -> 869, CLEAN 464 -> 461 (about -2,405 MSE at 344,341-row scale). MP7 gate passed. Non-LIRF unchanged. |
