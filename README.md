...
| kind-mango_v59 | pending | — | MF4: 1-day and 7-day rolling arrival-taxi-in drift features per airport, minus 2025 fit-month median. 4 new columns (117 -> 121 features). Retrained v57 base with these; LTFM +1.71 s and EGLL +1.31 s (both airports with big arrival drift per the mirror). LIRF unchanged. |
