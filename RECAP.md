...
Status as of 2026-09-19. Team best **287.83 s** (v55, live, -11.48 s vs v41). MB3 base filter (v51 -5.99 s) plus MB8 12-month refit of R_norm_LIRF (v55 -0.42 s). The winning theme is broader training exposure and label-free defensive gates; target reforms and head rebuilds have regressed.
