...
| tag | RMSE   | notes                                                |
|-----|--------|------------------------------------------------------|
| v59 | pending | Fifteenth-pass MF4: two 1-day and two 7-day arrival taxi-in drift features (`arr_txi_1d_med`, `arr_txi_7d_med`, `arr_txi_1d_drift`, `arr_txi_7d_drift`) added to the v57 base recipe. Median arrival TAXITIME_SEC_mvt at same airport on previous day and previous 7 days, minus 2025 fit-month per-airport median. Coverage 0.998 train / 0.982 rank. Retrained the v57 base with these 4 columns (117 -> 121 features). Non-LIRF shifts vs v57 small (-0.73 to +1.71 s), largest at LTFM (+1.71) and EGLL (+1.31) - airports with big arrival-side drift per the mirror. LIRF unchanged. Uploaded 2026-09-19. |
